  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 text-slate-900 font-sans overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="w-64 bg-slate-900 text-slate-400 flex flex-col border-r border-slate-800 z-0 shadow-xl">
          <nav className="flex-1 py-6 flex flex-col gap-1 px-3">
            <Link to="/" className="px-4 py-3 text-sm font-medium hover:bg-slate-800 hover:text-white rounded-lg transition-colors">
              Visão Geral
            </Link>
