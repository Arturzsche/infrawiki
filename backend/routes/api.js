...
// 1. Listar todos os estagiários (Sem criar automaticamente)
router.get('/estagiarios', async (req, res) => {
  try {
    const estagiarios = await Estagiario.find();
    // Apenas busca e devolve o que tem no banco (mesmo que seja zero)
...
// ADICIONAR TRABALHO (AGORA SALVA O STATUS)
...
// EDITAR TRABALHO (AGORA SALVA O STATUS)
